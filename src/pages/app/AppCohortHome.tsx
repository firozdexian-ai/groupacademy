...
function SessionCard({ session, past = false }: SessionCardProps) {
  return (
    <Card className="rounded-lg border border-border/60 bg-card/30 shadow-none overflow-hidden block w-full transform-gpu transition-colors hover:border-border-foreground/5">
