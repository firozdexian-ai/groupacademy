...
export default function AIGeneral() {
  ...
  return (
    <div className="max-w-4xl mx-auto h-[calc(100vh-145px)] md:h-[calc(100vh-80px)] flex flex-col bg-background overflow-hidden md:border-x border-border/40 shadow-none text-left antialiased transform-gpu w-full">
      ...
      <header className="flex items-center justify-between py-3.5 px-4 border-b border-border/40 bg-card/30 backdrop-blur-md shrink-0 z-20 select-none">
      ...
      <footer className="shrink-0 border-t border-border/40 bg-card/50 backdrop-blur-md p-4 select-none">
        <form
